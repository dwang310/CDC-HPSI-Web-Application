...
#network structure recorder for plotting purpose
...
infect <- function (dat,at) {  ##dat = data, at = at timestamp
  ...
  general_status <- get.vertex.attribute(nw,"general_status")
  ids_sus <- which(active == 1 & status == "s")
  ids_inf1 <- which(active == 1 & status == "i")
  ids_inf2 <- which(active == 1 & status == "i2")
  ids_inf3 <- which(active == 1 & status == "i3")
  general_status <- set.vertex.attribute(nw,"general_status",c(1),v=ids_inf1)
  general_status <- set.vertex.attribute(nw,"general_status",c(2),v=ids_inf2)
  general_status <- set.vertex.attribute(nw,"general_status",c(3),v=ids_inf3)
  general_status <- get.vertex.attribute(nw,"general_status")
  return(dat)
}
...
nw <- set.vertex.attribute(nw,"general_status",rep_len(0,networkSize))
